...
<a href="" id="printpagebutton" onclick="myFunction()"><B>Print</B></a>
		...
		<h3 class="one"><img src="img/logo.jpg"  /><br/>Official Receipt<br /><font color="red"><U>PAID</U></font></h3>
		<div class="printtitle">
			<hr>
<b> The company is located at Owl Empire Street in Milpark next to the Hollard Building<Br>
</b><hr></div>
		...
		<table border="" color="black">
            ...
            <td><div align="center" ><strong>E-VAT 14%</strong></div></td>
            </tr>
            <tr>
            <td align='center'>PAYPAL</td>
            <td > R150.00</td>
            <td ><?php echo 'R '.formatMoney($tax,2); ?></td>
            </tr>
            <tr>
