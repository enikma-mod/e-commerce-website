 ...
 <nav class="navbar navbar-inverse navbar-fixed-top">
      <div class="container">
        <div class="navbar-header">
          ...
          <a class="navbar-brand" href="index.php"> Wixstore</a>
        ...
        <div id="navbar" class="navbar-collapse collapse">
          <ul class="nav navbar-nav">
            ...
            <li><a href="server/index.php">  </a></li>
              </ul>
      ...
      <div id="carousel-example-generic" class="carousel slide" data-ride="carousel">
        ...
        <div class="carousel-inner" role="listbox">
          <div class="item active">
            <center><img src="img/John wick 2.jpg" alt="First slide"></center>
          </div>
          <div class="item">
            <center><img src="img/Space Between Us.jpg" alt="Second slide"></center>
          </div>
          <div class="item">
            <center><img src="img/The Edge of seventeen.jpg" alt="Third slide"></center>
          </div>
          <div class="item">
            <center><img src="img/Fist fight.jpg" alt="fourth slide"></center>
          </div>
...
<div  id="footerSection">
  <div class="row">
   ...
   <hr class="soft">
  <p class=""><marquee><font color="blue"></font></marquee></p>
