<hr class="soft">
    <p class=""><marquee><font color="black">Wixstore &copy; 2017  All rights reserved. Accept all major credit and debit cards. <?php echo date("Y")?></font></marquee></p>
    </div><!-- /container --></center>

</li></ul></body>
<center>
  <p font color="white">.<img style="float:right" src="img/visa.png"  height="50" width="50"><img style="float:right" src="img/mastercard.png"  height="50" width="50"><img style="float:right" src="./img/paypal.png"  height="50" width="50"</p> </center>
</footer> 
